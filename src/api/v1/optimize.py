...
from config.config import MODEL_OUTPUT_DIR, QUANTIZED_MODEL_OUTPUT_DIR, PRUNED_MODEL_OUTPUT_DIR
from log.logger import logger
from service.pruner_service import PrunerService
from service.quantizer_service import QuantizerService
...
def prune_model():
    try:
        ...
        PrunerService(saved_model_path, output_dir, prune_method).prune_model()
...
def quantize_model():
    try:
        ...
        QuantizerService(saved_model_path, output_dir, quantization_method).quantize_model()
